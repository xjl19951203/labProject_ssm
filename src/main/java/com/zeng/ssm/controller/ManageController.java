...
//    }
     ...
     */
    @RequestMapping(value = "", method = RequestMethod.GET)
    public PageResult getLists(@PathVariable String tableName,@RequestParam(defaultValue="1") Integer currentPage,@RequestParam(defaultValue="20") Integer pageSize) {
        ModelImpl.setTableName(tableName);
